...
\resheading{Skills}
	\begin{description}
		\item[Languages:] { \footnotesize C/C++, Python, CUDA, VHDL, Matlab, \LaTeX}
		...
		\item[Interests:] { \footnotesize Aviation and Aerospace Technology, History of Space Flight Technology, Cosmology, French Horn Performance, Snowboarding, Scuba, Travel }
