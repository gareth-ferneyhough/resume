...
\resheading{Skills}
	\begin{description}
		\item[Languages:] { \footnotesize C/C++, Python, QT, CUDA, VHDL, \LaTeX}
		\item[Computer and OS:] { \footnotesize Proficient developing and running software under Debian Linux and Windows; Experience developing parallel C++ applications using Open MPI; Some experience with embedded Linux development; User-interface design experience using QT; Strong Hardware and OS troubleshooting skills }
