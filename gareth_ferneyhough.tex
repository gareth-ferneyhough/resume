...
\resheading{Strenths}
	\begin{description}
		...
		\items[Web development:]  { \footnotesize Experience with Python Flask and deploying with Vagrant, Docker, and Amazon AWS; good knowledge of scalability concerns such as load-balancing, caching, and fault-tolerance  }
