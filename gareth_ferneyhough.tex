		...
		\item 
			\ressubheading{\href{http://www.hamiltoncompany.com/}{Hamilton Company}}{Reno, NV}{Software Engineer}{August 2012 -- Present}
				...
				\begin{itemize}
					...
					\resitem{Modernized and supported the build and deplopyment process for a large C++ project}
					\resitem{Advocated for the development of Python libraries to control our systems}					
				\end{itemize}
				}
