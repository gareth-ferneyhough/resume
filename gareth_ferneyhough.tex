...
\resheading{Strengths and Interests}
	...
	\begin{description}
		\item[Languages:] { \footnotesize JavaScript ES6, Modern C++, Python, C# }
		...
		\item[Web development:]  { \footnotesize Experience with React + Redux, AngularJS, and NodeJS backend development }
